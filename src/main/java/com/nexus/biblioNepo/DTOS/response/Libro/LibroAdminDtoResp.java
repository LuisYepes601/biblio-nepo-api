 ...
 * @author luis
 */
public class LibroAdminDtoResp {
    ...
    public LibroAdminDtoResp(Long id, String titulo, String subtitulo, String isbn, String editorial, LocalDate fechaPublicacion, Integer edicion, String portadaUrl, String publicIdPortada, String descripcion, String paisPublicacion, String formatoLibro, Long id_formatos_libro, Integer id_autor, String autor) {
        this.id = id;
        this.titulo = titulo;
