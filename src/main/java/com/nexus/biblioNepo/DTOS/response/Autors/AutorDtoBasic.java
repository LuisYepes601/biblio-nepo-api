...
public class AutorDtoBasic {
    ...
    public AutorDtoBasic(Integer id, String nombre, String segundoNombre, String primerApellido, String segundoApellido, LocalDate fechaNacimiento, LocalDate fechaFallecimiento, String urlFoto, Boolean isFallecido, Integer idPais, String pais) {
        this.id = id;
        this.nombre = nombre;
